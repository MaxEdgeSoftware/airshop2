...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        $redirectUrl = request()->get('redirect') ? request()->get('redirect') : '';

        $pageTitle = "Sign In";
        return view(activeTemplate() . 'user.auth.login', compact('pageTitle', 'redirectUrl'));
    }
    ...
    public function login(Request $request)
    {
        ...
        if ($this->attemptLogin($request)) {
            ...
            if($redirectUrl == '') return $this->sendLoginResponse($request);
