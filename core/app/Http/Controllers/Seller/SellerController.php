...
class SellerController extends Controller
{
    ...
    public function shop()
    {
        ...
        $seller     = seller();
        $shop       = $seller->shop;
        $country = Country::where("country_short", seller()->country_code)->first();

        return view('seller.shop', compact('country', 'pageTitle', 'seller', 'shop'));
    }
    ...
    public function shopUpdate(Request $request)
    {
        ...
        $slugify = $request->slug.'.'.env('APP_CDN');
        $shop->domain = $slugify;
    ...
    public function slugify(Request $request){
        ...
        $slugify = strtolower(Str::slug($request->name, '-'));
        return $this->uniqueSlug($slugify);
    }   

    public function uniqueSlug($slug){
        $isExist = Shop::where("domain", $slug.'.'.env('APP_CDN'))->first();
        if($isExist) {
