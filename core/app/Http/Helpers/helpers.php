...
function sidebarVariation(){
    ...
    $variation['selector'] = 'capsule--rounded';
    //for overlay
    $variation['overlay'] = 'bg--15';
    //Opacity
    $variation['opacity'] = 'none'; // 1-10
...
function paginateLinks($data, $design = 'panel.partials.paginate'){
...
function imagePath()
{
    ...
    $data['seller'] = [
        'profile'=> [
            'path'=>'assets/images/seller/profile',
            'size'=>'400x400'
        ],
        'shop_logo' => [
            'path'  => 'assets/images/seller/shop_logo',
            'size'  =>'400x400'
        ],
        'shop_cover'=> [
            'path'  => 'assets/images/seller/shop_cover',
            'size'  =>'1410x520'
        ],
    ];
...
{
    return "<$tag class='badge badge--$class'>". trans($content) ."</$tag>";
}
