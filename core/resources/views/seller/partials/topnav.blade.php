...
<nav class="navbar-wrapper">
    ...
    <div class="navbar__right">
        <ul class="navbar__action-list">
            ...
            <li class="dropdown">
                <button type="button" data-toggle="dropdown" data-display="static" aria-haspopup="true"
                    aria-expanded="false">
                    <span class="navbar-user">
                        <span class="navbar-user__thumb">
                            <img src="{{ getImage(imagePath()['seller']['profile']['path']. auth()->guard('seller')->user()->image, imagePath()['seller']['profile']['size']) }}"
                                alt="image"></span>
                        <span class="navbar-user__info">
                            <span
                                class="navbar-user__name">{{ auth()->guard('seller')->user()->username }}</span>
                        </span>
