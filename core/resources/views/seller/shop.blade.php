...
<script>
    ...
    (function($) {
        ...
        $('.add-social').on('click', function() {
            ...
            var content = `<div class="socials">
                                <div class="row">
                                    ...
                                    <p class="m-0"> <small class="text-primary">Select Icon</small> </p>
                                    </div>
        ...
        $("body").on("keyup", "#whatsappno", function(e) {
            generateWhatsappLink();
        })
        
        $("body").on("keyup", "#project_name", function(e) {
            slugify();
        })
        $("body").on("change", "#project_name", function(e) {
            slugify();
        })
        
        function generateWhatsappLink(){
            if($("#whatsappno").val() == "") return false;
            var value=$("#whatsappno").val(), country = $("#whatsappno").attr('data-country'), whatsapp = `${country}${value}`, http = `https://wa.me/${whatsapp}`;
            $("#whatsapplink").text(`${http} Try it` ).attr("href", http)
            
            $(".whatsapp_link_wrapper").show();
        }
        function slugify() {
